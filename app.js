...
const VIDEO_MODULES = [
  { num: '01', section: 'The Economic Mindset', videos: [
    { title: 'The Core of Economics: Scarcity vs. Infinite Desires', url: '' },
    { title: 'The 10 Principles: How Stickman thinks like an Economist', url: '' },
    { title: 'The Opportunity Cost: The hidden price of every decision', url: '' },
    { title: 'Incentives & Behavior: Why Stickman reacts to rewards', url: '' },
  ]},
  { num: '02', section: 'Market Dynamics — Supply & Demand', videos: [
    { title: 'The Demand Curve: Price vs. Quantity', url: '' },
    { title: 'The Supply Curve: The producer\'s perspective', url: '' },
    { title: 'Market Equilibrium: Finding the "Sweet Spot"', url: '' },
    { title: 'Surplus & Shortage: When markets fail to clear', url: '' },
    { title: 'Elasticity: Why some prices hurt more than others', url: '' },
  ]},
  { num: '03', section: 'The Business Engine — Costs & Production', videos: [
    { title: 'The Production Function: Stickman\'s inputs and outputs', url: '' },
    { title: 'Fixed vs. Variable Costs: Analyzing the garage-start-up', url: '' },
    { title: 'Marginal Analysis: The cost of the "next one"', url: '' },
    { title: 'Economies of Scale: Scaling the Stickman business', url: '' },
    { title: 'Competitive Markets: Surviving the price war', url: '' },
  ]},
  { num: '04', section: 'The Math of Time — Time Value of Money', videos: [
    { title: 'Intro to TVM: Why time is literally money', url: '' },
    { title: 'Future Value (FV): Compounding magic', url: '' },
    { title: 'Present Value (PV): Discounting future promises', url: '' },
    { title: 'Interest Rates: Nominal vs. Real (inflation adjustment)', url: '' },
    { title: 'Annuities: The math of regular savings', url: '' },
  ]},
  { num: '05', section: 'Valuation — Bonds & Stocks', videos: [
    { title: 'Debt Markets: How Bonds work', url: '' },
    { title: 'Bond Valuation: Prices, Yields, and Coupons', url: '' },
    { title: 'Equity Markets: Ownership in the modern world', url: '' },
    { title: 'Stock Valuation: The Dividend Discount Model (DDM)', url: '' },
    { title: 'Growth vs. Value: Stickman\'s investment style', url: '' },
  ]},
  { num: '06', section: 'Risk, Return & Portfolio Theory', videos: [
    { title: 'Defining Risk: Variance and Volatility', url: '' },
    { title: 'Historical Returns: Lessons from the past', url: '' },
    { title: 'Diversification: The "Free Lunch"', url: '' },
    { title: 'Systematic Risk: Why some risks can\'t be avoided', url: '' },
    { title: 'The CAPM Model: Calculating the required return', url: '' },
  ]},
  { num: '07', section: 'Macroeconomics — The Global Stage', videos: [
    { title: 'GDP Explained: Measuring the nation\'s output', url: '' },
    { title: 'The Cost of Living: CPI and the Inflation monster', url: '' },
    { title: 'Unemployment: Why it exists', url: '' },
    { title: 'The Circular Flow: How the whole system breathes', url: '' },
  ]},
  { num: '08', section: 'Money, Banking & Central Policy', videos: [
    { title: 'What is Money? History and Functions', url: '' },
    { title: 'The Banking System: Fractional reserves', url: '' },
    { title: 'The Federal Reserve: The world\'s bank', url: '' },
    { title: 'Monetary Policy: Interest rates and the money supply', url: '' },
  ]},
  { num: '09', section: 'Behavioral Economics & Personal Finance', videos: [
    { title: 'Rationality vs. Reality: The psychological Stickman', url: '' },
    { title: 'Cognitive Biases: Anchoring and FOMO', url: '' },
    { title: 'Loss Aversion: Why losing hurts more', url: '' },
    { title: 'Market Efficiency: Can you really beat the pros?', url: '' },
  ]},
  { num: '10', section: 'Corporate Finance & Final Project', videos: [
    { title: 'Capital Budgeting: Where should the money go?', url: '' },
    { title: 'NPV Rule: The gold standard of decision making', url: '' },
    { title: 'Capital Structure: Debt vs. Equity', url: '' },
    { title: 'Final Capstone: Stickman\'s IPO Financial Model', url: '' },
  ]},
];
