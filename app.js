...
/* ============================================================
   VIDEO COURSE — lessons grouped by module
   ------------------------------------------------------------
   HOW TO EDIT (для тебя):
   1) Вставляй ссылку на YouTube в "url" (например 'https://youtu.be/XXXXXXX').
   ...
   2) Число уроков в шапке ("🎬 Video Course — N Lessons") считается
      автоматически из этого массива — можно смело добавлять/удалять
      уроки, счётчик не разъедется.
   ============================================================ */
const VIDEO_MODULES = [
  { num: '01', section: 'The Economic Mindset', videos: [
    { title: 'The Core of Economics: Scarcity vs. Infinite Desires', url: 'https://youtu.be/2XGNH9thawQ' },
    { title: 'The 10 Principles: How Stickman thinks like an Economist', url: 'https://youtu.be/mvszJUKxYS0' },
    { title: 'The Opportunity Cost: The hidden price of every decision', url: 'https://youtu.be/OCAmSndtQmo' },
    { title: 'Incentives & Behavior: Why Stickman reacts to rewards', url: 'https://youtu.be/49j1uvA8HYM' },
  ]},
  { num: '02', section: 'Market Dynamics — Supply & Demand', videos: [
    { title: 'The Demand Curve: Price vs. Quantity', url: 'https://youtu.be/b-RE70s_2MI' },
    { title: 'The Supply Curve: The producer\'s perspective', url: 'https://youtu.be/tTfApCdMxqI' },
    { title: 'Market Equilibrium: Finding the "Sweet Spot"', url: 'https://youtu.be/-c3J_DHpk_w' },
    { title: 'Surplus & Shortage: When markets fail to clear', url: 'https://youtu.be/Gdjx3T7ob4A' },
    { title: 'Elasticity: Why some prices hurt more than others', url: 'https://youtu.be/Dich3qXtW2M' },
  ]},
  { num: '03', section: 'The Business Engine — Costs & Production', videos: [
    { title: 'The Production Function: Stickman\'s inputs and outputs', url: 'https://youtu.be/I-9mdQIy3y0' },
    { title: 'Fixed vs. Variable Costs: Analyzing the garage-start-up', url: 'https://youtu.be/mdz83OldPEU' },
    { title: 'Marginal Analysis: The cost of the "next one"', url: 'https://youtu.be/xTwvunGNcYg' },
    { title: 'Economies of Scale: Scaling the Stickman business', url: 'https://youtu.be/Sx8Nzv1fc4I' },
    { title: 'Competitive Markets: Surviving the price war', url: 'https://youtu.be/0ma8kYxPrO4' },
  ]},
  { num: '04', section: 'The Math of Time — Time Value of Money', videos: [
    { title: 'Intro to TVM: Why time is literally money', url: 'https://youtu.be/ZexnM60FVUA' },
    { title: 'Future Value (FV): Compounding magic', url: 'https://youtu.be/96C7bKpROUQ' },
    { title: 'Present Value (PV): Discounting future promises', url: 'https://youtu.be/x8gxl4ha6xU' },
    { title: 'Interest Rates: Nominal vs. Real (inflation adjustment)', url: 'https://youtu.be/ncuWO4IohYQ' },
    { title: 'Annuities: The math of regular savings', url: 'https://youtu.be/kW8RcaQ6HVE' },
  ]},
  { num: '05', section: 'Valuation — Bonds & Stocks', videos: [
    { title: 'Debt Markets: How Bonds work', url: 'https://youtu.be/GrNRG4IB1HM' },
    { title: 'Bond Valuation: Prices, Yields, and Coupons', url: 'https://youtu.be/s-arKo1Or0c' },
    { title: 'Equity Markets: Ownership in the modern world', url: 'https://youtu.be/ND8gDiGPuFI' },
    { title: 'Stock Valuation: The Dividend Discount Model (DDM)', url: 'https://youtu.be/qKFtioTgPQI' },
    { title: 'Growth vs. Value: Stickman\'s investment style', url: 'https://youtu.be/oLQT_4Au9qg' },
  ]},
  { num: '06', section: 'Risk, Return & Portfolio Theory', videos: [
    { title: 'Defining Risk: Variance and Volatility', url: 'https://youtu.be/O5vUVslFV-s' },
    { title: 'Historical Returns: Lessons from the past', url: 'https://youtu.be/1As9smHkUFk' },
    { title: 'Diversification: The "Free Lunch"', url: 'https://youtu.be/nwNTlg8qHCY' },
    { title: 'Systematic Risk: Why some risks can\'t be avoided', url: 'https://youtu.be/UxZ0VfvesTw' },
    { title: 'The CAPM Model: Calculating the required return', url: 'https://youtu.be/FmjCXHrzViY' },
  ]},
  { num: '07', section: 'Macroeconomics — The Global Stage', videos: [
    { title: 'GDP Explained: Measuring the nation\'s output', url: 'https://youtu.be/3ZbdnSbIqx8' },
    { title: 'The Cost of Living: CPI and the Inflation monster', url: 'https://youtu.be/DaOrqkde0wA' },
    { title: 'Unemployment: Why it exists', url: 'https://youtu.be/gjsWyCA2TIk' },
    { title: 'The Circular Flow: How the whole system breathes', url: 'https://youtu.be/eRC3_V-pmqE' },
  ]},
  { num: '08', section: 'Money, Banking & Central Policy', videos: [
    { title: 'What is Money? History and Functions', url: 'https://youtu.be/B_dZlPjtuek' },
    { title: 'The Banking System: Fractional reserves', url: 'https://youtu.be/OrzfELzy8U8' },
    { title: 'The Federal Reserve: The world\'s bank', url: 'https://youtu.be/qbgaqNXZqpo' },
    { title: 'Monetary Policy: Interest rates and the money supply', url: 'https://youtu.be/XvVDG3oAR_I' },
  ]},
  { num: '09', section: 'Behavioral Economics & Personal Finance', videos: [
    { title: 'Rationality vs. Reality: The psychological Stickman', url: 'https://youtu.be/aXgSnPQ8Ws8' },
    { title: 'Cognitive Biases: Anchoring and FOMO', url: 'https://youtu.be/Vp-hzxj7yLU' },
    { title: 'Loss Aversion: Why losing hurts more', url: 'https://youtu.be/S2YhuA7yX28' },
    { title: 'Market Efficiency: Can you really beat the pros?', url: 'https://youtu.be/ZQKKHm8BbXU' },
  ]},
  { num: '10', section: 'Corporate Finance & Final Project', videos: [
    { title: 'Capital Budgeting: Where should the money go?', url: 'https://youtu.be/voDY5uyGMQ4' },
    { title: 'NPV Rule: The gold standard of decision making', url: 'https://youtu.be/9qZs1L-JoIY' },
    { title: 'Capital Structure: Debt vs. Equity', url: 'https://youtu.be/pZ4t0PQxwEE' },
    { title: 'Final Capstone: Stickman\'s IPO Financial Model', url: 'https://youtu.be/tjpmSLO7_K0' },
  ]},
];
...
const TOOLS = [
  ...
  { id: 'videos', num: '🎬', section: 'Video Course', title: `Video Course — ${VIDEO_MODULES.reduce((n, m) => n + m.videos.length, 0)} Lessons`, desc: 'Every lesson from the course, grouped by module, with a direct link to each video on YouTube.', base: 'All videos: youtube.com/@liteconomics', render: renderVideoLibrary },
];
...
document.addEventListener('DOMContentLoaded', () => {
  buildNav();
  const ctaCount = $('#cta-video-count');
  if (ctaCount) {
    const total = VIDEO_MODULES.reduce((n, m) => n + m.videos.length, 0);
    ctaCount.textContent = `🎬 Video Course — ${total} Lessons`;
  }
  router();
});
